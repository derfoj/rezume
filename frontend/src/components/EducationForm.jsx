    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase">{t.degree} <span className="text-red-500">*</span></label>
                    <input
                        type="text" required
                ...
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase">{t.school} <span className="text-red-500">*</span></label>
                    <input
                        type="text" required
                        className="w-full p-2 border rounded text-sm"
             ...
             <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase">{t.mention}</label>
                    <input
                        type="text"
                        className="w-full p-2 border rounded text-sm"
            ...
            <div className="flex justify-end gap-2">
                <button type="button" onClick={onCancel} className="px-3 py-1 text-sm text-gray-600 hover:text-gray-800">{t.cancel}</button>
